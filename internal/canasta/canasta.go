...
func RewriteCaddy(installPath string) error {
	...
	_, err = fmt.Fprintln(writer, "# Auto-generated by Canasta CLI — DO NOT EDIT")
	if err != nil {
		return err
	}
	_, err = fmt.Fprintln(writer, "# To add custom Caddy directives, edit Caddyfile.custom instead.")
	if err != nil {
		return err
	}
	...
	// Write import directive for custom configuration
	_, err = fmt.Fprintln(writer, "import /etc/caddy/Caddyfile.custom")
	if err != nil {
		return err
	}
